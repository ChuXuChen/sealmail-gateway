...
public class CourseTeacherController {
    ...
    public List<java.util.Map<String, Object>> findMyCourse(@PathVariable Integer tid, @PathVariable String term) {
    ...
    public List<CourseTeacher> findByCtid(@PathVariable Integer ctid) {
        System.out.println("查询开课记录 By ctid: " + ctid);
        return courseTeacherService.findByCtid(ctid);
    }

    @PostMapping("/updateCourseTeacher")
    public boolean updateCourseTeacher(@RequestBody CourseTeacher courseTeacher) {
        System.out.println("正在修改开课记录: " + courseTeacher);
