...
public class SCTService {
    ...
    public List<SCTInfo> findBySearch(Map<String, String> map) {
        Integer sid = null, cid = null, tid = null, ctid = null;
     ...
     * @return 学生信息列表
     */
    public List<SCTInfo> findByCtid(Integer ctid) {
        return studentCourseTeacherMapper.findByCtid(ctid);
    }
}
